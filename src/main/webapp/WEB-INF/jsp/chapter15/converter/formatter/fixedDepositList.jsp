...
<body>
	<form name="fixedDepositList" method="POST"
			...
			<tr>
				<td>
					<table align="left" style="padding-left: 300px;">
						<tr>
							<td style="font-family: 'arial'; font-size: 16px; font-weight: bold;"><spring:message code="fd.list.title" /></td>
						</tr>
						<tr>
							<td>&nbsp;</td>
						</tr>
							...
							<td>
								<table class="border" cellpadding="10">
									<tr bgcolor="#99CCFF">
										...
										<th class="th"><spring:message code="fd.depositAmount.title" /></th>
									...
									<c:forEach items="${fdList}" var="fixedDeposit">
										<tr>
											...
											<td class="td"><a href="${pageContext.request.contextPath}/fixedDeposit?fdAction=close&fixedDepositId=${fixedDeposit.id}"
		...
		<table align="left" style="padding-left: 300px;">
			<tr>
				<td class="tdnoborder"><b>Language:</b> <a href="${pageContext.request.contextPath}/fixedDeposit/list?lang=en_US">English(US)</a>
