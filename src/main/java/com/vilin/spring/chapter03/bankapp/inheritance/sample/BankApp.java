package com.vilin.spring.chapter03.bankapp.inheritance.sample;

import com.vilin.spring.chapter03.bankapp.inheritance.sample.controller.FixedDepositController;
import com.vilin.spring.chapter03.bankapp.inheritance.sample.controller.PersonalBankingController;
import com.vilin.spring.chapter03.bankapp.inheritance.sample.controller.UserRequestController;
...
public class BankApp {
	...
	public static void main(String args[]) {
		ApplicationContext context = new ClassPathXmlApplicationContext(
				"classpath:com/vilin/spring/chapter03/bankapp/inheritance/sample/applicationContext.xml");
