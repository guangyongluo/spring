package com.vilin.spring.chapter09.bankapp.springdata.jpa;
...
import com.vilin.spring.chapter09.bankapp.springdata.jpa.service.BankAccountService;
import com.vilin.spring.chapter09.bankapp.springdata.jpa.service.FixedDepositService;
...
public class BankApp {
	...
	public static void main(String args[]) throws Exception {
		...
		context.scan("com.vilin.spring.chapter09.bankapp.springdata.jpa");
		context.refresh();
		...
		*/
		...
		logger.info("findByTenure(tenure, sort) : "
				+ fixedDepositService.findByTenure(6, Sort.by(Sort.Direction.ASC, "fdCreationDate")));
		...
		try (Stream<FixedDepositDetails> stream = fixedDepositService.findAllByTenure(6)) {
			stream.filter(t -> t.getActive().equals("Y")).count();
		}
