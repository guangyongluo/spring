...
import com.vilin.spring.chapter07.bankapp.more.service.AccountStatementService;
import com.vilin.spring.chapter07.bankapp.more.service.CustomerRegistrationService;
import com.vilin.spring.chapter07.bankapp.more.service.FixedDepositService;
...
public class BankApp {
	...
	public static void main(String args[]) throws Exception {
		...
		context.register(BankServicesConfig.class);
		context.register(BankHibernateDaosConfig.class);
		context.register(BankOtherObjects.class);
		context.register(BankMyBatisDaosConfig.class);
		context.refresh();
