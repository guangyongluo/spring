...
@Configuration
@PropertySource("classpath:com/vilin/spring/chapter10/bankapp/email.properties")
@PropertySource("classpath:com/vilin/spring/chapter10/bankapp/emailtemplate.properties")
