...
@ImportResource(locations = "classpath:com/vilin/spring/chapter10/bankapp/javaconfig/applicationContext.xml")
@Configuration
...
public class JmsConfig {
	...
	public ActiveMQConnectionFactory connectionFactory() {
		...
		trustedPackages.add("com.vilin.spring.chapter10.javaconfig.bankapp.domain");
