package com.vilin.spring.chapter10.bankapp;
...
import com.vilin.spring.chapter10.bankapp.service.BankAccountService;
import com.vilin.spring.chapter10.bankapp.service.FixedDepositService;
...
public class BankApp {
	...
	public static void main(String args[]) throws Exception {
		ConfigurableApplicationContext context = new ClassPathXmlApplicationContext("classpath:com/vilin/spring/chapter10/bankapp/applicationContext.xml");
		...
		fdd.setEmail("llooww@mail.ustc.edu.cn");
		...
		List<FixedDepositDetails> fixedDepositDetailsList = fixedDepositService.findFixedDepositsByBankAccount(bankAccountId);
