...
@Configuration
@PropertySource("classpath:/com/vilin/spring/chapter08/bankapp/javaconfig/hibernate/database.properties")
...
public class DatabaseConfig {
	...
	public SessionFactory sessionFactory(DataSource dataSource) {
		...
		builder.scanPackages("com.vilin.spring.chapter08.bankapp.javaconfig.hibernate.domain");
