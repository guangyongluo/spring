package com.vilin.spring.chapter15.async.webservice.client;

import java.util.List;

import com.vilin.spring.chapter15.async.webservice.client.domain.FixedDepositDetails;
...
public class FixedDepositWSClient {
	...
	public static void main(String args[]) {
		context = new ClassPathXmlApplicationContext("classpath:META-INF/spring/chapter15/async/bankapp/webservice/client/applicationContext.xml");
	...
	private static void getFixedDeposit(RestTemplate restTemplate) {
		ResponseEntity<FixedDepositDetails> responseEntity = restTemplate
				.getForEntity(
						"http://localhost:8080/spring/fixedDeposits?id=1",
	...
	private static void editFixedDeposit(RestTemplate restTemplate) {
		...
		ResponseEntity<FixedDepositDetails> responseEntity = restTemplate
				.exchange(
						"http://localhost:8080/spring/fixedDeposits?id=2",
