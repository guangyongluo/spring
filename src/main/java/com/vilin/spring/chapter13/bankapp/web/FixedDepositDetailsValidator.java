package com.vilin.spring.chapter13.bankapp.web;

import com.vilin.spring.chapter13.bankapp.domain.FixedDepositDetails;
...
public class FixedDepositDetailsValidator implements Validator {
	...
	public void validate(Object target, Errors errors) {
		...
		if (!NumberUtils.isNumber(depositAmount)) {
			...
			errors.rejectValue("depositAmount", "error.depositAmount.less", "must be greater than or equal to 1000");
		}
		...
		if (!NumberUtils.isNumber(tenure)) {
			...
			errors.rejectValue("tenure", "error.tenure.less", "must be greater than or equal to 12");
		}
