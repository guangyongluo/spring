package com.vilin.spring.chapter14.web;

import java.util.List;

import com.vilin.spring.chapter14.domain.FixedDepositDetails;
import com.vilin.spring.chapter14.exception.ValidationException;
import com.vilin.spring.chapter14.service.FixedDepositService;
...
public class FixedDepositController {
	...
	public ResponseEntity<List<FixedDepositDetails>> getFixedDepositList() {
		...
		return new ResponseEntity<List<FixedDepositDetails>>(fixedDepositService.getFixedDeposits(), HttpStatus.OK);
	}
	...
	public ResponseEntity<FixedDepositDetails> getFixedDeposit(@RequestParam("id") int id) {
		...
		return new ResponseEntity<FixedDepositDetails>(fixedDepositService.getFixedDeposit(id), HttpStatus.OK);
	}
