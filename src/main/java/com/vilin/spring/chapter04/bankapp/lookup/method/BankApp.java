package com.vilin.spring.chapter04.bankapp.lookup.method;

import com.vilin.spring.chapter04.bankapp.lookup.method.domain.FixedDepositDetails;
import com.vilin.spring.chapter04.bankapp.lookup.method.service.CustomerRequestService;
import com.vilin.spring.chapter04.bankapp.lookup.method.service.FixedDepositService;
...
public class BankApp {
	...
	public static void main(String args[]) throws Exception {
		ApplicationContext context = new ClassPathXmlApplicationContext(
				"classpath:com/vilin/spring/chapter04/bankapp/lookup/method/spring/applicationContext.xml");
