package com.vilin.spring.chapter04.bankapp.replaced.method;

import com.vilin.spring.chapter04.bankapp.replaced.method.domain.FixedDepositDetails;
import com.vilin.spring.chapter04.bankapp.replaced.method.service.CustomerRequestService;
import com.vilin.spring.chapter04.bankapp.replaced.method.service.FixedDepositService;
...
public class BankApp {
	...
	public static void main(String args[]) throws Exception {
		ApplicationContext context = new ClassPathXmlApplicationContext(
				"classpath:com/vilin/spring/chapter04/bankapp/replaced/method/spring/applicationContext.xml");
